...
namespace KPMG.KTech
{
...

    {
        ...
        public static async Task Main(string[] args)
        {
			...
			ParseValidString().Wait();
			ParseAddressFromCidrNotation().Wait();
			VerifyIpAddressIsInCidrRange().Wait();
		...
		private async static Task ParseValidString()
		{
		...
		private async static Task ParseAddressFromCidrNotation()
		{
		...
		private async static Task VerifyIpAddressIsInCidrRange()
		{
